...
Post from ~3 weeks ago, not captured in prior entries: Hawkins poured 300m³ of concrete on the Tauranga High and District Court project using a sustainable fly ash mix — a second sustainability-materials signal alongside the CLT work already logged.

**Finding — Minister Penk site visit with named subcontractors**
Hawkins hosted Minister Chris Penk on site (~3 weeks ago) to discuss construction-sector opportunities, alongside subcontractors D&H Steel, Thermosash, Hanlon Plumbing, and Marin Construction. New government-engagement signal and a useful map of Hawkins' active subcontractor network.

**Finding — Massey University Construction Experience Day**
Participation in Massey University's Construction Experience Day (~3 weeks ago) — extends the talent-pipeline theme already visible in the Career Streams Parliament launch and the 40-student Jobs & Skills Hub partnership.

**Finding — New detail on previously logged items**
The Domestic Jet Terminal pier's cross-laminated timber flooring is being manufactured by Red Stag, cited for reduced embodied carbon (supplier not previously named). Property Industry Awards specifics now visible: Court Theatre took Judges' Choice, Te Ara Mātauranga Library a civic award (project not previously logged), Beca House a sustainability award. The Building People Awards ceremony is dated 14 August 2026. Followers ticked up to 61,268 (from 61,265). Source: nz.linkedin.com/company/hawkinsnz public snapshot.
...
## ASSET:linkedin:hawkinsnz 2026-07-04 17:35 → Hawkins holds the top spot in BCI Central's 2025 NZ Construction League with $1.2B across 31 projects started in 2024, anchored by the ~$800M Auckland Airport domestic jet terminal (first new terminal at Auckland in ~50 years, opening 2029, tower cranes up as of 2026). Five live projects each exceed $200M, including the $329M Wellington Town Hall redevelopment, Skyline Queenstown gondola redevelopment, and Ikea Sylvia Park. Also primary contractor for Te Whare Toroa at RNZAF Base Ōhakea (P8-A Poseidon simulator facility, in use 2026). Sources: hawkins.co.nz/news, b2bnews.co.nz, passengerterminaltoday.com, nzherald.co.nz.
